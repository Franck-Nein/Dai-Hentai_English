...
- (void)onLoginUsingExKeyPress {
    UIAlertController *loginCookieAlert = [UIAlertController alertControllerWithTitle:@"Login with Cookie" message:@"Please enter cookies here" preferredStyle:UIAlertControllerStyleAlert];
